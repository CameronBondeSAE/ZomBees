...
namespace OpenAI_API.Chat
{
	...
	public class Conversation
	{
		...
		public void InsertMessageAtStart(ChatMessage message)
		{
		...
		{
			foreach (var chatMessage in _Messages.FindAll(message => message.Role == ChatMessageRole.System))
			{
				_Messages.Remove(chatMessage);
			}
			// AppendSystemMessage(content);
			InsertMessageAtStart(new ChatMessage(ChatMessageRole.System, content));
		}
