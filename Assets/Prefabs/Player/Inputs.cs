...
public partial class @Inputs : IInputActionCollection2, IDisposable
{
    ...
    public struct IngameActions
    {
        ...
        public void SetCallbacks(IIngameActions instance)
        {
            if (m_Wrapper.m_IngameActionsCallbackInterface != null)
            {
                ...
                @Pickupleft.started -= m_Wrapper.m_IngameActionsCallbackInterface.OnPickupleft;
                @Pickupleft.performed -= m_Wrapper.m_IngameActionsCallbackInterface.OnPickupleft;
                @Pickupleft.canceled -= m_Wrapper.m_IngameActionsCallbackInterface.OnPickupleft;
                @Pickupright.started -= m_Wrapper.m_IngameActionsCallbackInterface.OnPickupright;
                @Pickupright.performed -= m_Wrapper.m_IngameActionsCallbackInterface.OnPickupright;
                @Pickupright.canceled -= m_Wrapper.m_IngameActionsCallbackInterface.OnPickupright;
                @Dropleft.started -= m_Wrapper.m_IngameActionsCallbackInterface.OnDropleft;
                @Dropleft.performed -= m_Wrapper.m_IngameActionsCallbackInterface.OnDropleft;
                @Dropleft.canceled -= m_Wrapper.m_IngameActionsCallbackInterface.OnDropleft;
                @Dropright.started -= m_Wrapper.m_IngameActionsCallbackInterface.OnDropright;
                @Dropright.performed -= m_Wrapper.m_IngameActionsCallbackInterface.OnDropright;
                @Dropright.canceled -= m_Wrapper.m_IngameActionsCallbackInterface.OnDropright;
                @Uselefthand.started -= m_Wrapper.m_IngameActionsCallbackInterface.OnUselefthand;
                @Uselefthand.performed -= m_Wrapper.m_IngameActionsCallbackInterface.OnUselefthand;
                @Uselefthand.canceled -= m_Wrapper.m_IngameActionsCallbackInterface.OnUselefthand;
                @Userighthand.started -= m_Wrapper.m_IngameActionsCallbackInterface.OnUserighthand;
                @Userighthand.performed -= m_Wrapper.m_IngameActionsCallbackInterface.OnUserighthand;
                @Userighthand.canceled -= m_Wrapper.m_IngameActionsCallbackInterface.OnUserighthand;
    ...
    private IIngametalkingActions m_IngametalkingActionsCallbackInterface;
    ...
    public struct IngametalkingActions
    {
        ...
        {
            if (m_Wrapper.m_IngametalkingActionsCallbackInterface != null)
            {
                @Cancel.started -= m_Wrapper.m_IngametalkingActionsCallbackInterface.OnCancel;
                @Cancel.performed -= m_Wrapper.m_IngametalkingActionsCallbackInterface.OnCancel;
                @Cancel.canceled -= m_Wrapper.m_IngametalkingActionsCallbackInterface.OnCancel;
                @Sendmessage.started -= m_Wrapper.m_IngametalkingActionsCallbackInterface.OnSendmessage;
                @Sendmessage.performed -= m_Wrapper.m_IngametalkingActionsCallbackInterface.OnSendmessage;
                @Sendmessage.canceled -= m_Wrapper.m_IngametalkingActionsCallbackInterface.OnSendmessage;
            }
            m_Wrapper.m_IngametalkingActionsCallbackInterface = instance;
            if (instance != null)
            {
